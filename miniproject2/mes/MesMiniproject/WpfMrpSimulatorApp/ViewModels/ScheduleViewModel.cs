...
namespace WpfMrpSimulatorApp.ViewModels
{
    public partial class ScheduleViewModel : ObservableObject
    {
        ...
        private readonly IoTDbContext ioTDbContext = new IoTDbContext();
        ...
        public async Task SaveData()
        {
            ...
            try
            {
                ...
                using (MySqlConnection conn = new MySqlConnection(Common.CONNSTR))
                {
                    ...
                    cmd.Parameters.AddWithValue("@codeName", SelectedSchedule.SchFacilityId);
                    cmd.Parameters.AddWithValue("@codeDesc", SelectedSchedule.SchEntTime);
